...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} scroll-smooth antialiased h-full`}>
      <body className="min-h-full flex flex-col font-sans bg-white text-gray-900 selection:bg-blue-200">
        <Navbar />
        <main className="flex-1 pt-[72px] lg:pt-[88px] selection:bg-blue-100 selection:text-blue-900">
          {children}
        </main>
        <Footer />
        <MobileStickyBar />
