      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-100 shadow-xl shadow-blue-900/5 flex flex-col items-start group hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">100% Vaastu Compliant Designs</h3>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-100 shadow-xl shadow-blue-900/5 flex flex-col items-start group hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Triple-Checked Structural Integrity</h3>
            <p className="text-gray-600 font-medium leading-relaxed">
